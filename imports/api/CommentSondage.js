...
export const CommentSondage = new Mongo.Collection('CommentSondage');
...
Meteor.publish('reponsesSingleSondage', function (reponse) {
new SimpleSchema({
      reponse: {type: String},
    }).validate({reponse});

  return CommentSondage.find({'postId':reponse});
});
}
