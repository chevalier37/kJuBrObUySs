...
class ListeMesArticles extends Component {
		...
		return (
			<div className="ListeMessages">
	  			...
	  			<Segment color={colorSexe=="pink" ?
		  			...
		  			<div className={this.props.message.valider==false ? "NonValider" : "none"}>
		  				Article non publié - en cours de modération
		  			</div>

		  			<div className={this.props.message.refuse==true ? "NonValider" : "none"}>
		  				Article refusé
		  			</div>
	      				...
	      				<Comment.Content>
							...
							<div className="IconListeArticle">
								<div className="textIcon">{this.props.message.nbrReponse}</div>
	         					<Img className="iconMenu" src="/comment.svg"/>
							</div>
							<div className="IconListeArticle">
							...
							<div className="textIcon">{this.props.message.vues}</div>
	         					<Img className="iconMenu" src="/eye.svg"/>
							</div>

							<div className="SupprimerArticle">
	          						<Button 
	          						 size="mini"
	          						 color="red"
	          						 onClick={this.supprimerArticle.bind(this)}
	          						 >
	          							Supprimer
	          						</Button>
	          					</div>
...
export default ListeMesArticles =  withTracker(({ id }) => {
